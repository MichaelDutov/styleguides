...
Данное руководство является адаптацией полезных советов из книги
[Robert C. Martin's _Clean Code_]
в применении к языку программирования [ABAP](https://ru.wikipedia.org/wiki/ABAP).

Краткая [шпаргалка](cheat-sheet/CheatSheet.md) оптимизирована для печати.

[Robert C. Martin's _Clean Code_]: https://www.oreilly.com/library/view/clean-code/9780136083238/
[_Чистый код: создание, анализ и рефакторинг. Библиотека программиста, Роберт Мартин_]: https://www.piter.com/collection/A27-854/product/chistyy-kod-sozdanie-analiz-i-refaktoring-biblioteka-programmista-45ccca

<!-- @Translators: kindly add the following disclaimer to the document. -->
Основной версией оригинального документа является [текущая англоязычная версия](CleanABAP.md).
Этот вольный перевод относится к [версии от 30 Апреля 2020]().
Для совместных обсуждений и внесения правок в оригинальном документе используйте, пожалуйста, английский язык.
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#how-to)

### How to Get Started with Clean Code

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Полезная информация](#how-to) > [Текущий раздел](#how-to-get-started-with-clean-code)

Если Вы впервые столкнулись с понятием Чистый код, рекомендуем прочесть книгу [Robert C. Martin's _Clean Code_] или её руссоязычную версию [_Чистый код: создание, анализ и рефакторинг. Библиотека программиста, Роберт Мартин_].
Также полезной может оказаться [Инициатива разработчиков Чистого Кода](https://clean-code-developer.com/).
Эти ресурсы в академическом стиле пошагово раскрывают тему Чистого Кода вцелом.

Азы чистого кода лучше постигать с простых разделов, которые легко понять и принять.
Например [Booleans](#booleans), [Условия](#conditions), и [Условные ветвления](#ifs).

Вероятно наиболее заметный результат принесёт ознакомление с разделом [Методы](#methods),
в особенности [Do one thing, do it well, do it only](#do-one-thing-do-it-well-do-it-only) и [Small](#keep-methods-small),
т.к. их применение значительно улучшает общую структуру кода.

Некоторые темы могут вызвать серьёзные дискуссии в командах,
опытных в своей предметной области, но мало знакомых с принципами и практиками Чистого Кода.
Чаще всего сложности возникают только вначале и связаны с самим дискомфортом,
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Полезная информация](#how-to) > [Текущий раздел](#how-to-relate-to-other-guides)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Полезная информация](#how-to) > [Текущий раздел](#how-to-disagree)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#names)

### Use descriptive names

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Наименования](#names) > [Текущий раздел](#use-descriptive-names)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Наименования](#names) > [Текущий раздел](#prefer-solution-domain-and-problem-domain-terms)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Наименования](#names) > [Текущий раздел](#use-plural)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Наименования](#names) > [Текущий раздел](#use-pronounceable-names)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Наименования](#names) > [Текущий раздел](#avoid-abbreviations)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Наименования](#names) > [Текущий раздел](#use-same-abbreviations-everywhere)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Наименования](#names) > [Текущий раздел](#use-nouns-for-classes-and-verbs-for-methods)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Наименования](#names) > [Текущий раздел](#avoid-noise-words-such-as-data-info-object)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Наименования](#names) > [Текущий раздел](#pick-one-word-per-concept)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Наименования](#names) > [Текущий раздел](#use-pattern-names-only-if-you-mean-them)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Наименования](#names) > [Текущий раздел](#avoid-encodings-esp-hungarian-notation-and-prefixes)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#language)

### Mind the legacy

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Language](#language) > [Текущий раздел](#mind-the-legacy)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Language](#language) > [Текущий раздел](#mind-the-performance)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Language](#language) > [Текущий раздел](#prefer-object-orientation-to-procedural-programming)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Language](#language) > [Текущий раздел](#prefer-functional-to-procedural-language-constructs)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Language](#language) > [Текущий раздел](#avoid-obsolete-language-elements)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Language](#language) > [Текущий раздел](#use-design-patterns-wisely)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#constants)

### Use constants instead of magic numbers

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Константы](#constants) > [Текущий раздел](#use-constants-instead-of-magic-numbers)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Константы](#constants) > [Текущий раздел](#prefer-enumeration-classes-to-constants-interfaces)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Константы](#constants) > [Текущий раздел](#if-you-dont-use-enumeration-classes-group-your-constants)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#variables)

### Prefer inline to up-front declarations

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Переменные](#variables) > [Текущий раздел](#prefer-inline-to-up-front-declarations)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Переменные](#variables) > [Текущий раздел](#dont-declare-inline-in-optional-branches)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Переменные](#variables) > [Текущий раздел](#do-not-chain-up-front-declarations)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Переменные](#variables) > [Текущий раздел](#prefer-ref-to-to-field-symbol)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#tables)

### Use the right table type

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Таблицы](#tables) > [Текущий раздел](#use-the-right-table-type)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Таблицы](#tables) > [Текущий раздел](#avoid-default-key)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Таблицы](#tables) > [Текущий раздел](#prefer-insert-into-table-to-append-to)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Таблицы](#tables) > [Текущий раздел](#prefer-line_exists-to-read-table-or-loop-at)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Таблицы](#tables) > [Текущий раздел](#prefer-read-table-to-loop-at)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Таблицы](#tables) > [Текущий раздел](#prefer-loop-at-where-to-nested-if)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Таблицы](#tables) > [Текущий раздел](#avoid-unnecessary-table-reads)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#strings)

### Use ` to define literals

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Строки](#strings) > [Текущий раздел](#use--to-define-literals)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Строки](#strings) > [Текущий раздел](#use--to-assemble-text)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#booleans)

### Use Booleans wisely

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Booleans](#booleans) > [Текущий раздел](#use-booleans-wisely)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Booleans](#booleans) > [Текущий раздел](#use-abap_bool-for-booleans)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Booleans](#booleans) > [Текущий раздел](#use-abap_true-and-abap_false-for-comparisons)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Booleans](#booleans) > [Текущий раздел](#use-xsdbool-to-set-boolean-variables)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#conditions)

### Try to make conditions positive

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Условия](#conditions) > [Текущий раздел](#try-to-make-conditions-positive)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Условия](#conditions) > [Текущий раздел](#prefer-is-not-to-not-is)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Условия](#conditions) > [Текущий раздел](#consider-decomposing-complex-conditions)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Условия](#conditions) > [Текущий раздел](#consider-extracting-complex-conditions)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#ifs)

### No empty IF branches

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Условные ветвления](#ifs) > [Текущий раздел](#no-empty-if-branches)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Условные ветвления](#ifs) > [Текущий раздел](#prefer-case-to-else-if-for-multiple-alternative-conditions)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Условные ветвления](#ifs) > [Текущий раздел](#keep-the-nesting-depth-low)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#regular-expressions)

### Prefer simpler methods to regular expressions

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Регулярные выражения](#regular-expressions) > [Текущий раздел](#prefer-simpler-methods-to-regular-expressions)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Регулярные выражения](#regular-expressions) > [Текущий раздел](#prefer-basis-checks-to-regular-expressions)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Регулярные выражения](#regular-expressions) > [Текущий раздел](#consider-assembling-complex-regular-expressions)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#classes)

### Classes: Object orientation

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Текущий раздел](#classes-object-orientation)

#### Prefer objects to static classes

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Classes: Object orientation](#classes-object-orientation) > [Текущий раздел](#prefer-objects-to-static-classes)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Classes: Object orientation](#classes-object-orientation) > [Текущий раздел](#prefer-composition-to-inheritance)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Classes: Object orientation](#classes-object-orientation)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Текущий раздел](#scope)

#### Global by default, local only where appropriate

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Scope](#scope) > [Текущий раздел](#global-by-default-local-only-where-appropriate)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Scope](#scope) > [Текущий раздел](#final-if-not-designed-for-inheritance)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Scope](#scope) > [Текущий раздел](#members-private-by-default-protected-only-if-needed)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Scope](#scope) > [Текущий раздел](#consider-using-immutable-instead-of-getter)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Scope](#scope) > [Текущий раздел](#use-read-only-sparingly)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Текущий раздел](#constructors)

#### Prefer NEW to CREATE OBJECT

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Constructors](#constructors) > [Текущий раздел](#prefer-new-to-create-object)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Constructors](#constructors) > [Текущий раздел](#if-your-global-class-is-create-private-leave-the-constructor-public)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Constructors](#constructors) > [Текущий раздел](#prefer-multiple-static-creation-methods-to-optional-parameters)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Constructors](#constructors) > [Текущий раздел](#use-descriptive-names-for-multiple-creation-methods)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Классы](#classes) > [Constructors](#constructors) > [Текущий раздел](#make-singletons-only-where-multiple-instances-dont-make-sense)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#methods)

These rules apply to methods in classes and function modules.

### Calls

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Текущий раздел](#calls)

#### Prefer functional to procedural calls

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Calls](#calls) > [Текущий раздел](#prefer-functional-to-procedural-calls)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Calls](#calls) > [Текущий раздел](#omit-receiving)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Calls](#calls) > [Текущий раздел](#omit-the-optional-keyword-exporting)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Calls](#calls) > [Текущий раздел](#omit-the-parameter-name-in-single-parameter-calls)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Calls](#calls) > [Текущий раздел](#omit-the-self-reference-me-when-calling-an-instance-method)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Текущий раздел](#methods-object-orientation)

#### Prefer instance to static methods

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Methods: Object orientation](#methods-object-orientation) > [Текущий раздел](#prefer-instance-to-static-methods)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Methods: Object orientation](#methods-object-orientation) > [Текущий раздел](#public-instance-methods-should-be-part-of-an-interface)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Текущий раздел](#parameter-number)

#### Aim for few IMPORTING parameters, at best less than three

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Parameter Number](#parameter-number) > [Текущий раздел](#aim-for-few-importing-parameters-at-best-less-than-three)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Parameter Number](#parameter-number) > [Текущий раздел](#split-methods-instead-of-adding-optional-parameters)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Parameter Number](#parameter-number) > [Текущий раздел](#use-preferred-parameter-sparingly)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Parameter Number](#parameter-number) > [Текущий раздел](#return-export-or-change-exactly-one-parameter)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Текущий раздел](#parameter-types)

#### Prefer RETURNING to EXPORTING

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Parameter Types](#parameter-types) > [Текущий раздел](#prefer-returning-to-exporting)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Parameter Types](#parameter-types) > [Текущий раздел](#returning-large-tables-is-usually-okay)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Parameter Types](#parameter-types) > [Текущий раздел](#use-either-returning-or-exporting-or-changing-but-not-a-combination)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Parameter Types](#parameter-types) > [Текущий раздел](#use-changing-sparingly-where-suited)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Parameter Types](#parameter-types) > [Текущий раздел](#split-method-instead-of-boolean-input-parameter)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Текущий раздел](#parameter-names)

#### Consider calling the RETURNING parameter RESULT

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Parameter Names](#parameter-names) > [Текущий раздел](#consider-calling-the-returning-parameter-result)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Текущий раздел](#parameter-initialization)

#### Clear or overwrite EXPORTING reference parameters

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Parameter Initialization](#parameter-initialization) > [Текущий раздел](#clear-or-overwrite-exporting-reference-parameters)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Parameter Initialization](#parameter-initialization) > [Текущий раздел](#take-care-if-input-and-output-could-be-the-same)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Parameter Initialization](#parameter-initialization) > [Текущий раздел](#dont-clear-value-parameters)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Текущий раздел](#method-body)

#### Do one thing, do it well, do it only

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Method Body](#method-body) > [Текущий раздел](#do-one-thing-do-it-well-do-it-only)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Method Body](#method-body) > [Текущий раздел](#focus-on-the-happy-path-or-error-handling-but-not-both)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Method Body](#method-body) > [Текущий раздел](#descend-one-level-of-abstraction)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Method Body](#method-body) > [Текущий раздел](#keep-methods-small)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Текущий раздел](#control-flow)

#### Fail fast

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Control flow](#control-flow) > [Текущий раздел](#fail-fast)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Control flow](#control-flow) > [Текущий раздел](#check-vs-return)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Методы](#methods) > [Control flow](#control-flow) > [Текущий раздел](#avoid-check-in-other-positions)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#error-handling)

### Messages

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Текущий раздел](#messages)

#### Make messages easy to find

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Сообщения](#messages) > [Текущий раздел](#make-messages-easy-to-find)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Текущий раздел](#return-codes)

#### Prefer exceptions to return codes

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Коды возврата](#return-codes) > [Текущий раздел](#prefer-exceptions-to-return-codes)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Коды возврата](#return-codes) > [Текущий раздел](#dont-let-failures-slip-through)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Текущий раздел](#exceptions)

#### Exceptions are for errors, not for regular cases

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Exceptions](#exceptions) > [Текущий раздел](#exceptions-are-for-errors-not-for-regular-cases)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Exceptions](#exceptions) > [Текущий раздел](#use-class-based-exceptions)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Текущий раздел](#throwing)

#### Use own super classes

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Throwing](#throwing) > [Текущий раздел](#use-own-super-classes)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Throwing](#throwing) > [Текущий раздел](#throw-one-type-of-exception)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Throwing](#throwing) > [Текущий раздел](#use-sub-classes-to-enable-callers-to-distinguish-error-situations)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Throwing](#throwing) > [Текущий раздел](#throw-cx_static_check-for-manageable-exceptions)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Throwing](#throwing) > [Текущий раздел](#throw-cx_no_check-for-usually-unrecoverable-situations)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Throwing](#throwing) > [Текущий раздел](#consider-cx_dynamic_check-for-avoidable-exceptions)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Throwing](#throwing) > [Текущий раздел](#dump-for-totally-unrecoverable-situations)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Throwing](#throwing) > [Текущий раздел](#prefer-raise-exception-new-to-raise-exception-type)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Текущий раздел](#catching)

#### Wrap foreign exceptions instead of letting them invade your code

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Обработка ошибок](#error-handling) > [Catching](#catching) > [Текущий раздел](#wrap-foreign-exceptions-instead-of-letting-them-invade-your-code)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#comments)

### Express yourself in code, not in comments

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Комментарии](#comments) > [Текущий раздел](#express-yourself-in-code-not-in-comments)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Комментарии](#comments) > [Текущий раздел](#comments-are-no-excuse-for-bad-names)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Комментарии](#comments) > [Текущий раздел](#use-methods-instead-of-comments-to-segment-your-code)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Комментарии](#comments) > [Текущий раздел](#write-comments-to-explain-the-why-not-the-what)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Комментарии](#comments) > [Текущий раздел](#design-goes-into-the-design-documents-not-the-code)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Комментарии](#comments) > [Текущий раздел](#comment-with--not-with-)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Комментарии](#comments) > [Текущий раздел](#put-comments-before-the-statement-they-relate-to)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Комментарии](#comments) > [Текущий раздел](#delete-code-instead-of-commenting-it)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Комментарии](#comments) > [Текущий раздел](#use-fixme-todo-and-xxx-and-add-your-id)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Комментарии](#comments) > [Текущий раздел](#dont-add-method-signature-and-end-of-comments)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Комментарии](#comments) > [Текущий раздел](#dont-duplicate-message-texts-as-comments)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Комментарии](#comments) > [Текущий раздел](#abap-doc-only-for-public-apis)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Комментарии](#comments) > [Текущий раздел](#prefer-pragmas-to-pseudo-comments)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#formatting)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#be-consistent)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#optimize-for-reading-not-for-writing)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#use-the-pretty-printer-before-activating)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#use-your-pretty-printer-team-settings)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#no-more-than-one-statement-per-line)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#stick-to-a-reasonable-line-length)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#condense-your-code)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#add-a-single-blank-line-to-separate-things-but-not-more)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#dont-obsess-with-separating-blank-lines)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#align-assignments-to-the-same-object-but-not-to-different-ones)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#close-brackets-at-line-end)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#keep-single-parameter-calls-on-one-line)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#keep-parameters-behind-the-call)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#if-you-break-indent-parameters-under-the-call)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#line-break-multiple-parameters)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#align-parameters)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#break-the-call-to-a-new-line-if-the-line-gets-too-long)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#indent-and-snap-to-tab)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#indent-in-line-declarations-like-method-calls)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Formatting](#formatting) > [Текущий раздел](#dont-align-type-clauses)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Текущий раздел](#testing)

### Principles

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Текущий раздел](#principles)

#### Write testable code

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Principles](#principles) > [Текущий раздел](#write-testable-code)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Principles](#principles) > [Текущий раздел](#enable-others-to-mock-you)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Principles](#principles) > [Текущий раздел](#readability-rules)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Principles](#principles) > [Текущий раздел](#dont-make-copies-or-write-test-reports)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Principles](#principles) > [Текущий раздел](#test-publics-not-private-internals)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Principles](#principles) > [Текущий раздел](#dont-obsess-about-coverage)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Текущий раздел](#test-classes)

#### Call local test classes by their purpose

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Test Classes](#test-classes) > [Текущий раздел](#call-local-test-classes-by-their-purpose)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Test Classes](#test-classes) > [Текущий раздел](#put-tests-in-local-classes)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Test Classes](#test-classes) > [Текущий раздел](#put-help-methods-in-help-classes)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Test Classes](#test-classes) > [Текущий раздел](#how-to-execute-test-classes)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Текущий раздел](#code-under-test)

#### Name the code under test meaningfully, or default to CUT

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Code Under Test](#code-under-test) > [Текущий раздел](#name-the-code-under-test-meaningfully-or-default-to-cut)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Code Under Test](#code-under-test) > [Текущий раздел](#test-against-interfaces-not-implementations)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Code Under Test](#code-under-test) > [Текущий раздел](#extract-the-call-to-the-code-under-test-to-its-own-method)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Текущий раздел](#injection)

#### Use dependency inversion to inject test doubles

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Injection](#injection) > [Текущий раздел](#use-dependency-inversion-to-inject-test-doubles)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Injection](#injection) > [Текущий раздел](#consider-to-use-the-tool-abap-test-double)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Injection](#injection) > [Текущий раздел](#exploit-the-test-tools)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Injection](#injection) > [Текущий раздел](#use-test-seams-as-temporary-workaround)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Injection](#injection) > [Текущий раздел](#use-local-friends-to-access-the-dependency-inverting-constructor)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Injection](#injection) > [Текущий раздел](#dont-misuse-local-friends-to-invade-the-tested-code)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Injection](#injection) > [Текущий раздел](#dont-change-the-productive-code-to-make-the-code-testable)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Injection](#injection) > [Текущий раздел](#dont-sub-class-to-mock-methods)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Injection](#injection) > [Текущий раздел](#dont-mock-stuff-thats-not-needed)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Injection](#injection) > [Текущий раздел](#dont-build-test-frameworks)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Текущий раздел](#test-methods)

#### Test method names: reflect what's given and expected

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Test Methods](#test-methods) > [Текущий раздел](#test-method-names-reflect-whats-given-and-expected)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Test Methods](#test-methods) > [Текущий раздел](#use-given-when-then)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Test Methods](#test-methods) > [Текущий раздел](#when-is-exactly-one-call)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Test Methods](#test-methods) > [Текущий раздел](#dont-add-a-teardown-unless-you-really-need-it)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Текущий раздел](#test-data)

#### Make it easy to spot meaning

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Test Data](#test-data) > [Текущий раздел](#make-it-easy-to-spot-meaning)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Test Data](#test-data) > [Текущий раздел](#make-it-easy-to-spot-differences)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Test Data](#test-data) > [Текущий раздел](#use-constants-to-describe-purpose-and-importance-of-test-data)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Текущий раздел](#assertions)

#### Few, focused assertions

> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Assertions](#assertions) > [Текущий раздел](#few-focused-assertions)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Assertions](#assertions) > [Текущий раздел](#use-the-right-assert-type)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Assertions](#assertions) > [Текущий раздел](#assert-content-not-quantity)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Assertions](#assertions) > [Текущий раздел](#assert-quality-not-content)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Assertions](#assertions) > [Текущий раздел](#use-fail-to-check-for-expected-exceptions)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Assertions](#assertions) > [Текущий раздел](#forward-unexpected-exceptions-instead-of-catching-and-failing)
...
> [Чистый код в ABAP](#clean-abap) > [Содержание](#content) > [Тестирование](#testing) > [Assertions](#assertions) > [Текущий раздел](#write-custom-asserts-to-shorten-code-and-avoid-duplication)
